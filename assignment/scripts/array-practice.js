...
let favoriteFoods = ['pasta', 'raisins', 'french onion soup', 'smoked trout' ];
...
console.log('First animal is', animalArray[1]);
...
console.log(`Added a new favorite food to beginning: ${favoriteFoods}`);
